...
de 0 a N Mascotas, que contenga nombre y qué animal es, ambos de tipo String. Debe tener
los métodos necesarios para agregar nuevos datos o eliminar cada uno de los existentes
(menos los datos de la persona). Determinar si corresponde utilizar composición y agregación.
 *  
 */
